...
Define the framework-neutral core runtime behavior for canonical form schemas. This capability covers submitted path parsing, dangerous-key rejection, schema analysis, MVP validation primitives, condition evaluation, hidden-value filtering, normalized submission envelope creation, backend response parsing, migration runner behavior, fixture compatibility, and phase reporting.
