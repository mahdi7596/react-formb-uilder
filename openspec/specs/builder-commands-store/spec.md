...
Define the React builder package's command and editor-store foundation. This capability covers React-free schema editing commands, structured command diagnostics, dangerous-change warnings, editor UI state coordination, and undo/redo history before visual builder UI work begins.
